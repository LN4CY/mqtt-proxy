...
Create three interface wrapper classes that all implement the same `_handleFromRadio()` override:
...
- [x] Extract common `_handleFromRadio()` logic into shared function
- [ ] Move TCP-specific code into `RawTCPInterface` class
